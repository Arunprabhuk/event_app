...
function Event() {
  const { userDetails } = useSelector((state) => state.eventAuth);
  ...
  const onSubmitReason = () => {
    dispatch(updateReason(state.reason));
    setState((prev) => ({
      ...prev,
      openModel: false,
    }));
      ...
      <Agenda
        ...
        renderItem={(item, isFirst) => (
          ...
          >
            ...
            >
              <MaterialIcons size={23} color={"#eebf80"} name="description" />
              <FontAwsom5
